...
If we were to try to inspect the metadata of one of the recordings using `soxi`, this would fail.

```{bash}
#| output-fold: true
soxi "2003_11_15__Brian_Eno__The_Long_Now.mp3"
```
...
For this, here is a k-nearest neighbors (kNN) classification analysis script written in Python.
