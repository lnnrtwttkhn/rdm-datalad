...
That's why the code examples below are commented out.
...
#| echo: false
#| output: false
git config user.name "Ford Escort"
git config user.email 42@H2G2.com
...
Don't worry about configurations for now.
